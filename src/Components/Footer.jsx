...
const Footer = () => {
  ...
  <nav className="grid grid-flow-col gap-4">
    ...
    <a className="link link-hover">Install</a>
  </nav>
  <nav>
  ...
  <aside className='border-t-2 w-full'>
    <p className='mt-3'>Copyright © {new Date().getFullYear()} - All right reserved by ACME Industries Ltd</p>
  </aside>
</footer>
    );
};
